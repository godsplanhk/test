...
export const salesNavigatorCompany = async (req:Request, res:Response) => {
    try {
        // Extract parameters from request body
        const { url, page, account_number } = req.body;
        ...
        const options = {
            method: "POST",
            url: "https://linkedin-sales-navigator-no-cookies-required.p.rapidapi.com/premium_search_company_via_url",
            headers: {
